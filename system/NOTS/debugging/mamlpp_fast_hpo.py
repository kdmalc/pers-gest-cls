# This isnt super up to date and idk if its even worth using ... esp over vanilla MAML
...
if __name__ == "__main__":
    ...
    journal_path = os.path.join(db_dir, "mamlpp_DUMMY_CNNLSTMMLP_2fcv_hpo.log")

    run_study(
        study_name="mamlpp_DUMMY_CNNLSTMMLP_2fcv_hpo",
